...
public class ChartFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		conm = new float[] { 6.5f, 6.4f, 6.5f, 6.3f, 6.3f, 6.2f, 6.2f,
				6.3f, 6.0f, 5.9f, 5.8f, 5.7f, 5.7f, 5.6f, 5.6f, 5.5f, 5.4f,
				5.3f, 5.3f, 5.3f, 5.2f, 5.1f, 5.3f, 5.4f, 5.4f, 5.3f, 5.2f,
				4.9f, 4.8f, 4.7f, 4.6f, 4.5f, 4.3f };
